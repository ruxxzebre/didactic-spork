...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"handlers.js":[function(require,module,exports) {
"use strict";
...
var main_mod = require("_bundle_loader")(require.resolve('./index'));

var JSON5_mod = require("_bundle_loader")(require.resolve('json5'));

var input = document.getElementById('input');
var output = document.getElementById('output');
var labelToggler = document.getElementById('parseWithLabels');
var editModeToggler = document.getElementById('editMode');
var parseWithLabels = false;
var editMode = false;
var prevPressedKey = '';
input.focus();
...
function inputListener(_x) {
  return _inputListener.apply(this, arguments);
}

function _inputListener() {
  _inputListener = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var main, JSON5, obj;
...
function keyPressTogglerListener(e) {
  ...
  var wrapper = function wrapper(elem, additional) {
    e.preventDefault();
  ...
  switch (e.key) {
    ...
    case '1':
      return wrapper(labelToggler);

    case '2':
      return wrapper(editModeToggler, function () {
        return input.select();
      });
...
function dispatchInput() {
  var forceEvent = new Event('input');
  input.dispatchEvent(forceEvent);
}

function dispatchChange(elem) {
  var forceEvent = new Event('change');
  elem.dispatchEvent(forceEvent);
}
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","_bundle_loader":"../node_modules/parcel-bundler/src/builtins/bundle-loader.js","./index":[["src.e31bb0bc.js","index.js"],"src.e31bb0bc.js.map","index.js"],"json5":[["dist.3cb108c6.js","../node_modules/json5/dist/index.js"],"dist.3cb108c6.js.map","../node_modules/json5/dist/index.js"]}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js",0,"handlers.js"], null)
//# sourceMappingURL=/handlers.cf3c1ba6.js.map